...
pygame.mixer.init() #for thw sound
...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(meteor_img, (33,28))
        self.image.set_colorkey(BLACK)
        self.rect = self.image.get_rect()
        self.radius = 14 #or use int(self.rect_width*(a factor. eg 0.5))
        #pygame.draw.circle(self.image, RED, self.rect.center, self.radius)
...
while running:
    ...
    pygame.display.flip() #flip the display after drawing everything
